...
This repository contains the following datasets for the polymer model used in the manuscript.

1. Production MD structures

The repository provides the molecular structures used in the production MD simulations, including:

the initial structure of each production MD run, and

the final structure after the production MD simulation.
...
The repository also includes the molecular topology (.top) files used in the MD simulations, which define:

molecular connectivity,

bonded interactions, and

force-field related parameters for the polymer systems.
...
If you use the data in this repository, please cite the following manuscript:
