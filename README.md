...
This dataset includes molecular dynamics (MD) simulation trajectories and representative structures for the polymer models used in this work.

---

## 1. Production MD Trajectories for RAFT Reaction Model in Toluene

## 2. Production MD Trajectories for STY Radical System in DMSO

## 3. Production MD Trajectories for DA Reaction Model
